...
namespace TurboJpegWrapper
{
    ...
    public class TJCompressor : IDisposable
    {
        ...
        /// <param name="tjPixelFormat">Pixel format of the source image (see <see cref="PixelFormat"/> "Pixel formats").</param>
        /// <param name="subSamp">
        ...
        /// </summary>
        /// <param name="srcBuf">
        /// Image array containing RGB, grayscale, or CMYK pixels to be compressed.
        /// </param>
        /// <param name="stride">
        /// Bytes per line in the source image.
        /// Normally, this should be <c>width * BytesPerPixel</c> if the image is unpadded,
        ...
        /// Releases resources.
        /// </summary>
        /// <param name="callFromUserCode">callFromUserCode.</param>
